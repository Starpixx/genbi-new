...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-md p-8">
        <h2 class="text-2xl font-bold text-center text-blue-900 mb-6" id="formTitle">Register</h2>
        ...
        <form action="#" method="POST" id="authForm">
            ...
            <button type="submit" class="w-full bg-blue-900 text-white py-2 rounded hover:bg-blue-700 transition">Register</button>
        </form>
        
        <p class="text-center text-gray-600 mt-4">
            Sudah punya akun? <a href="#" class="text-blue-900 font-bold" id="toggleForm">login sekarang</a>
        </p>
    </div>
